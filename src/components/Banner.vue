  ...
  <v-layout row wrap>  
    <v-flex xs12 sm12 md4 lg5 xl4 >  
      <div class="banner-bio">
        ...
        <p>
          Con más de 4 años de experiencia en desarrollo web y un sólido conocimiento técnico, tengo la capacidad de contribuir de manera significativa a cualquier equipo y proyecto en los que participe.
